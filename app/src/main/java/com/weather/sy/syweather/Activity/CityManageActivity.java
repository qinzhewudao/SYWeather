...
import com.weather.sy.syweather.Adapter.CityManageAdapter;
import com.weather.sy.syweather.Bean.CityManageContext;
import com.weather.sy.syweather.Bean.WeatherBean;
import com.weather.sy.syweather.Db.LoveCity;
import com.weather.sy.syweather.Fragment.CityFragment;
...
import com.weather.sy.syweather.View.SlideCutListView;
                        ...
                        setPositiveButton("确定", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                if(name.equals(HandleDaoData.getShowCity())){
                                    ...
                                    Intent intent = new Intent("com.weather.sy.syweather.Activity.LOCAL_BROADCAST");
